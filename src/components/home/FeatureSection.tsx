...
const FeatureCard = ({ title, description, icon, isVisible, delay = 0 }: FeatureCardProps) => {
  return (
    <div 
      className={cn(
      ...
      <div className="container max-w-7xl mx-auto px-4 sm:px-6">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-gray-600">
            Everything you need to organize and manage college sports events efficiently.
          </p>
        </div>
